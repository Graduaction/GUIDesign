...
namespace Model
{
    ...
    public class MyLinkList<T>
    {
        ...
        //合并链表
        public void Merge(MyLinkList<T> myLinkList1, MyLinkList<T> myLinkList2)//合并链表
        {
            if (myLinkList1.Head != null)
            {                
                Node<T> p =myLinkList1.head;
                int len1 =myLinkList1.GetLength();
                while (p.Next != null)
                {                    
                    p = p.Next;
                }
                p.Next = myLinkList2.Head;                               
            }
        }
    }
}
